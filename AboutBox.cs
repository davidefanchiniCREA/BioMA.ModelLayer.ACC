...
namespace CRA.ModelLayer.ACC
{
    partial class AboutBox : Form
    {
        ...
        public AboutBox(APIdefinition aPIdefinition)
        {
            InitializeComponent();
            ad = aPIdefinition;
        ...
        {
            MLLicense lic = new MLLicense(ad);
            lic.Show();
        }

        private void btnHelp_Click(object sender, EventArgs e)
        {
            const string hFile = @"Help\\ACC_User_Guide.chm";
            Help.ShowHelp(this, hFile, HelpNavigator.TableOfContents);
        }
